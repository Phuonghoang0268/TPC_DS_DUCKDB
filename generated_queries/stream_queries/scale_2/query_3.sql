...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Men','Electronics','Music') and
          i_class in ('pants','camcorders','country')
         )
      or (i_category in ('Women','Jewelry','Books') and
          i_class in ('swimwear','custom','travel') 
        ))
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-12' as date) 
                  and (cast('2001-08-12' as date) +  interval '14 days')
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-09' as date) 
                  and (cast('2000-08-09' as date) +  interval '30 days')
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (10,3,6,9,5,1) and
       d_year = 2000 and
       ca_state in ('GA','ND','LA'
                   ,'TN','OH','CO','ID')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('snow','maroon','moccasin'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 6
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('NE', 'MO', 'AL')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('PA', 'KY', 'IL')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MN', 'CO', 'ID')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Springfield'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  319
   and ib_upper_bound   <=  319 + 50000
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Stark County','Crowley County','Barry County','Vermilion Parish','Washington County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '98759','12250','40802','62929','13900','97135',
                          '51726','47424','84457','25919','12959',
                          '64710','73971','62472','15398','49357',
                          '15840','51013','83180','63706','65721',
                          '73025','87804','35503','52610','94540',
                          '94038','93107','49590','17254','17328',
                          '91608','14544','46252','59449','37030',
                          '90886','52286','28659','69812','20239',
                          '38594','45652','60630','19745','10097',
                          '83132','40770','92001','65660','90271',
                          '20969','77421','52318','84335','94680',
                          '42924','54061','44468','73687','76318',
                          '60546','22690','77274','19747','40449',
                          '48335','85340','41805','76741','98071',
                          '47704','45945','99510','79349','61452',
                          '21877','45566','57059','72107','73796',
                          '36639','91302','50540','85561','94799',
                          '95392','18005','36148','93265','56569',
                          '48070','87838','72216','13144','94072',
                          '14842','88347','61414','89491','53198',
                          '38487','70323','74840','70191','66627',
                          '15932','88687','46560','39251','16722',
                          '36346','13298','88752','49881','43129',
                          '49312','40296','67593','38331','94105',
                          '18723','93450','71417','87988','88126',
                          '75657','80655','48286','19376','42322',
                          '81317','28010','33823','64131','11466',
                          '49338','23963','72889','82982','95861',
                          '93995','55088','73827','58577','92888',
                          '13498','87937','24828','27202','56813',
                          '34223','72135','36882','44008','99372',
                          '95020','91338','26370','52552','53836',
                          '71255','18447','10965','66795','53993',
                          '72531','94631','29315','30633','85681',
                          '21958','35755','58808','38402','91073',
                          '12336','62088','82143','29243','19521',
                          '69386','77352','74306','43711','66337',
                          '89079','67770','13138','71330','36091',
                          '19342','67051','64471','77581','41382',
                          '78147','85929','43520','97550','80407',
                          '59329','77057','69316','61651','16777',
                          '74949','10337','90198','43647','92765',
                          '42101','35616','61140','73568','33316',
                          '94689','52774','89722','57637','54879',
                          '70376','58124','92219','51348','56029',
                          '51245','95154','25980','28256','14827',
                          '91772','86173','96247','18531','57821',
                          '64240','11992','83570','53721','88044',
                          '33600','73123','42541','42734','69953',
                          '16647','51262','76890','91864','95476',
                          '47920','18971','41005','51775','42095',
                          '99143','61653','80477','32757','90540',
                          '36326','97809','90939','44024','71664',
                          '13112','77277','39563','19282','21263',
                          '88200','50745','99930','72408','17330',
                          '15464','19289','36964','18427','36875',
                          '64572','67176','75218','28590','86346',
                          '15361','70018','94459','64820','74451',
                          '73328','61805','75472','44047','53561',
                          '59331','55959','74163','64565','11622',
                          '87032','44065','60700','27694','77060',
                          '47746','32722','61019','68936','59725',
                          '35982','23230','76314','56806','48772',
                          '99189','32583','41573','75045','53086',
                          '21669','49668','56430','67324','23019',
                          '76914','46607','56500','94077','22731',
                          '96178','49745','69561','25701','95620',
                          '33749','11759','93353','46179','76784',
                          '26986','52307','57531','89008','52233',
                          '28047','47396','43805','47420','85676',
                          '82031','14853','69786','73194','17226',
                          '31277','32475','89928','63658','42047',
                          '15219','98057','77805','86908','73775',
                          '24123','81684','99121','89692','53822',
                          '99866','26359','37341','86583','33293',
                          '56916','28882','55328','61741','93616',
                          '91474','36144','54669','74666','98205',
                          '27818','89240','92185','73731','10959',
                          '78825','52802','95656','66932','17709',
                          '29010','12464','81133','56235')
     intersect
      select ca_zip
...
select  i_item_id
 ...
 and d_date between cast('1998-01-31' as date) and (cast('1998-01-31' as date) + interval '60 days')
 and i_manufact_id in (677,955,838,835)
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 16057 and 16057+28800 
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2002-05-17' as date) - interval '30 days')
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-06-07' as date) and (cast('1998-06-07' as date) +  interval '60 days')
 and i_manufact_id in (631,566,428,205)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 761 and 761+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'purple' or i_color = 'cornflower') and
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-03-18' as date) - interval '30 days')
                and (cast ('2002-03-18' as date) + interval '30 days') 
 group by
    w_state,i_item_id
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-01-28','1999-09-20','1999-11-13')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 9 and 9+10 
             or ss_coupon_amt between 13809 and 13809+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 46 and 46+10
          or ss_coupon_amt between 15121 and 15121+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 10 and 10+10
          or ss_coupon_amt between 12989 and 12989+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 136 and 136+10
          or ss_coupon_amt between 11974 and 11974+1000
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('olive','cornsilk','red','orange','lace','tan') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 49408
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 674
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 52165
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 58226
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 15908
            then (select avg(ss_ext_tax)
                  from store_sales
...
and d_date between '1998-03-03' and 
        (cast('1998-03-03' as date) + interval '90 days')
...
where 
	...
	and d_date between cast('1999-04-11' as date) 
				and (cast('1999-04-11' as date) + interval '30 days')
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-15' as date) 
                  and (cast('2001-08-15' as date) +  interval '30 days') 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  i_item_id
 ...
 from	catalog_sales
     ...
     ,date_dim
 where cs_item_sk = i_item_sk 
   and i_category in ('Shoes', 'Sports', 'Men')
   and cs_sold_date_sk = d_date_sk

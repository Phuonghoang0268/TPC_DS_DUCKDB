...
where 
	...
	and d_date between cast('1999-05-25' as date) 
				and (cast('1999-05-25' as date) + interval '30 days')
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-12' as date) 
                  and (cast('2000-08-12' as date) +  interval '30 days')
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('1999-05-04' as date) - interval '30 days')
                    and (cast ('1999-05-04' as date) + interval '30 days')
...
select  i_item_id
 ...
 and d_date between cast('2002-01-20' as date) and (cast('2002-01-20' as date) +  interval '60 days')
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2001-02-24' as date) - interval '30 days')
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-03-22' as date) and (cast('2002-03-22' as date) + interval '60 days')
...
where 
	...
	and d_date between cast('2001-06-05' as date) 
				and (cast('2001-06-05' as date) + interval '30 days')
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and d_date between cast('2001-04-06' as date) 
 				and (cast('2001-04-06' as date) + interval '30 days')
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
and d_date between '1998-03-24' and 
        (cast('1998-03-24' as date) + interval '90 days')

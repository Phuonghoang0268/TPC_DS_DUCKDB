...
and d_date between '2002-01-29' and 
        (cast('2002-01-29' as date) + interval '90 days')
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-03' as date) 
                  and (cast('2000-08-03' as date) +  interval '30 days') 
...
where 
	...
	and d_date between cast('2002-05-13' as date) 
				and (cast('2002-05-13' as date) + interval '30 days')
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and d_date between cast('1998-07-03' as date) and (cast('1998-07-03' as date) +  interval '60 days')
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-03-30' as date) and (cast('2000-03-30' as date) +  interval '60 days')
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('1999-04-18' as date) - interval '30 days')
                    and (cast ('1999-04-18' as date) + interval '30 days')
